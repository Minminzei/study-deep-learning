...
#### 5-4. 転移学習、ファインチューニング
ResNetとEfficientNetを対象に転移学習、ファインチューニングを100 epochずつ行い、zero学習とパフォーマンスを比較する

|  モデル  |  学習タイプ  |  検証データの正解率 | テストデータの正解率 |
|--------|------|------| ------| 
| ResNet | 0からの学習 |60% | 60%| 
| ResNet | ファインチューニング |60% | 60%| 
| ResNet | 転移学習 |60% | 60%| 
| EfficientNet | 0からの学習 |60% | 60%| 
| EfficientNet | ファインチューニング |60% | 60%| 
| EfficientNet | 転移学習 |60% | 60%| 
